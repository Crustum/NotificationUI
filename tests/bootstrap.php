...
use Crustum\NotificationUI\NotificationUIPlugin;
...
$cache = [
    ...
    '_cake_translations_' => [
        'className' => 'File',
        'prefix' => 'notificaion_test_cake_core_',
    ...
    '_cake_model_' => [
        'className' => 'File',
        'prefix' => 'notificaion_test_cake_model_',
        'path' => CACHE . 'models/',
        'serialize' => 'File',
        'duration' => '+10 seconds',
    ],
...
Plugin::getCollection()->add(new NotificationUIPlugin([
    'path' => dirname(dirname(__FILE__)) . DS,
    'routes' => true,
]));

Plugin::getCollection()->add(new NotificationPlugin([
    'routes' => true,
]));
