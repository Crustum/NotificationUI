...
- [Bell Widget](#bell-widget)
- [Display Modes](#display-modes)
- [Configuration Options](#configuration-options)
- [Real-Time Broadcasting](#real-time-broadcasting)
- [Notification Data Fields](#notification-data-fields)
- [API Endpoints](#api-endpoints)
- [JavaScript Events](#javascript-events)
- [Template Overloading](#template-overloading)
- [Alpine.js Architecture](#alpinejs-architecture)
